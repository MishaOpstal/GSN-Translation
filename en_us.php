<?php
	...
	$LAN['ADD_SERVER_TIPS'] = "If you want to add a server by hostname(domain), please <a class='alert-link' href='http://www.gsnet.work/forums/viewforum.php?f=5' target='_blank'>post it on our forum</a>.";
	$LAN['IN'] = "in";
	$LAN['SERVERS'] = "servers";
?>