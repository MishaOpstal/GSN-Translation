<?php
	...
	$LAN['ADD_SERVER_SUCCESS_MSG'] = "You have successfully added this server to GS-M! This server will be monitored, you can get the server status less than 5 minutes as the server is online.";
