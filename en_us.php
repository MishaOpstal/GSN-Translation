<?php
	...
	$LAN['HCOUNT'] = "HCount";
	$LAN['HSIGN'] = "Signature";
	$LAN['HCOUNT_HELP'] = "In order to change the image's color, change 255,255,255 to what you like in RGB";
	$LAN['HSIGN_HELP'] = "Change the two 255,255,255 to change title/content color, change en_us to set language";
	...
	$LAN['ADD_SERVER_TIPS'] = "If you want to add a server by hostname(domain), please <a class='alert-link' href='http://http://www.gsnet.work/forums/viewforum.php?f=5' target='_blank'>post it on our forum</a>.";
	$LAN['IN'] = "in";
	$LAN['SERVERS'] = "servers";
?>